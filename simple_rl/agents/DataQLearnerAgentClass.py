...
class DataQLearnerAgent(Agent):
    ''' Implementation for a Q Learning Agent '''

    def __init__(self, actions, name="qlearner", alpha=0.05, gamma=0.99, epsilon=0.1, explore=" ", anneal=False,mdp=None):
        '''
        Args:
    ...
    def future_action(self):
        t=self.mdp.t
        return self.mdp.allDiscreteActions[t,:]
    ...
    def act(self, state, reward, learning=True):
        ...
        Summary:
            ...
            Retrieves the action according to the current time step
            stored in the mdp and performs updates given (s=self.prev_state,
        ...
        if learning and self.anneal:
            raise ValueError("Annealing is not possible with DataAgent ")
